...
function journalUpdateModalOpen(data) {
	...
	const optionList = (option) => {
		return transactionTypeMap[option];
	}
	
	const debitOptions = getOptions(optionList(data.transactionType).DEBIT);
	const creditOptions = getOptions(optionList(data.transactionType).CREDIT);
